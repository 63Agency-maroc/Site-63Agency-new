...
const translations = {
  fr: {
    ...
    'form.success.title': 'Informations envoyées',
    'form.success.text': 'Votre demande a bien été reçue. Nous vous recontactons rapidement.',
    'form.success.again': 'Envoyer une autre demande',
    'form.success.meta.name': 'Nom',
    'form.success.meta.email': 'Email',
    'form.success.meta.phone': 'Téléphone',
    ...
    'about.method.title': 'Notre méthode pour attirer,<br>qualifier et convertir',
    'about.levers.title': 'Nos leviers clés',
    'about.levers.1': 'Benchmark, positionnement & offre',
    'about.levers.2': 'Contenu & créas qui convertissent',
    'about.levers.3': 'Meta, Instagram & Google Ads',
    'about.levers.4': 'Tunnel de qualification & formulaires',
    'about.levers.5': 'CRM, WhatsApp & relances',
    'about.levers.6': 'Tracking leads, RDV et ROI',
  ...
  en: {
    ...
    'form.success.title': 'Information sent',
    'form.success.text': 'Your request has been received. We will get back to you shortly.',
    'form.success.again': 'Send another request',
    'form.success.meta.name': 'Name',
    'form.success.meta.email': 'Email',
    'form.success.meta.phone': 'Phone',
    ...
    'about.method.title': 'Our method to attract,<br>qualify and convert',
    'about.levers.title': 'Our key levers',
    'about.levers.1': 'Benchmark, positioning & offer',
    'about.levers.2': 'Content & creatives that convert',
    'about.levers.3': 'Meta, Instagram & Google Ads',
    'about.levers.4': 'Qualification funnel & forms',
    'about.levers.5': 'CRM, WhatsApp & follow-ups',
    'about.levers.6': 'Lead, meeting & ROI tracking',
