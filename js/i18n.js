...
const translations = {
  fr: {
    ...
    'hero.title': 'Générez entre <span class="hero__mark">150 et 14&nbsp;000</span><br>prospects <span class="hero__mark">qualifiés</span> chaque mois.',
    'hero.subtitle': 'Des leads prêts à prendre rendez-vous — adaptés à votre capacité et à vos objectifs.',
    'hero.note': 'Maroc & France · Éducation · Services B2B & B2C · Immobilier',
    ...
    'ads.meta.text': 'Campagnes Meta / Instagram conçues pour générer des demandes via formulaires : volume, coût par lead, budget et performance — suivis en continu.',
    ...
    'testimonials.tarik.quote': '« Je travaille avec Saad et 63 Agency depuis plus de 4 ans. Sérieux, fiable, constant. On a généré de vrais résultats — la relation est basée sur la confiance. »',
    ...
    'faq.a1': 'Nous générons des prospects qualifiés pour les entreprises de services : écoles, formations, B2B/B2C, immobilier. Objectif clair : des leads qui peuvent devenir des rendez-vous et des clients — pas seulement de la visibilité.',
    'faq.q2': 'Pour qui êtes-vous faits ?',
    'faq.a2': 'Pour les entreprises au Maroc et en France qui vendent un service et veulent un flux prévisible de demandes qualifiées. Idéal si vous avez déjà une offre claire et une équipe (ou un process) pour traiter les leads.',
    ...
    'cta.text': 'Si vous vendez un service et voulez un système d’acquisition clair au Maroc ou en France, parlons-en. Places limitées pour garder la qualité.',
    ...
    'contact.sidebar.desc': "Lors de cet échange, on vous partage un plan d'action clair pour générer plus de leads qualifiés et améliorer votre ROI — au Maroc comme en France.",
    ...
    'sys.2.text': 'Meta & Google orientées prospects qualifiés — pas de budget gaspillé.',
    ...
    'promise.heading': 'Spécialistes de la génération de prospects qualifiés<span class="promise__dot">.</span>',
    ...
    'about.hero.title': 'Des leads. Pas seulement de la visibilité.',
    'about.hero.lead': '63 Agency aide les entreprises de services au Maroc et en France à générer des prospects qualifiés — rapidement, clairement, mesurablement.',
    'about.story.1': 'Nous accompagnons les entreprises qui veulent arrêter de “faire du marketing” pour commencer à remplir leur pipeline commercial.',
    'about.story.2': 'Notre méthode combine quatre leviers : contenu, publicité, qualification et suivi commercial.',
    'about.story.3': 'L’objectif : attirer les bonnes personnes, les convertir en prospects qualifiés, et transformer plus d’opportunités en clients.',
    'about.path.eyebrow': 'Le parcours d’acquisition',
    'about.path.title': 'Nous ne vendons pas des clics. Nous construisons un flux de prospects.',
    'about.path.sub': 'Voici le parcours que nous installons :',
    ...
    'about.metric.title': 'La seule métrique qui compte : la croissance.',
    'about.metric.1': 'Notre travail ne s’arrête pas au formulaire rempli.',
    'about.metric.2': 'On regarde ce qui se passe après : réponses, rendez-vous, présence, clients signés.',
    'about.metric.3': 'Parce que le marketing n’a de valeur que s’il développe votre chiffre d’affaires.',
  ...
  en: {
    ...
    'hero.note': 'Morocco & France · Education · B2B & B2C services · Real estate',
    'hero.cta': 'Talk to an expert',
    'partners.title': 'Trusted<br>by',
    'partners.aria': 'Partners',

    'why.title': 'Why 63 Agency exists',
    'why.text': 'Too many businesses pay for visibility… and get cold leads. 63 Agency builds a clear acquisition system: attract the right people, qualify them, and turn them into sales appointments. If you sell a service and want genuinely interested prospects, you’re in the right place.',
    ...
    'ads.meta.text': 'Meta / Instagram campaigns built to generate form requests: volume, cost per lead, budget and performance — tracked continuously.',
    ...
    'testimonials.samir.quote': '“Clearly the best agency experience we’ve had. Serious, results-driven work — nothing like our previous collaborations.”',
    ...
    'testimonials.tarik.role': 'CEO — Oum Palace & New Hotel',
    'testimonials.tarik.quote': '“I’ve worked with Saad and 63 Agency for over 4 years. Serious, reliable, consistent. We generated real results — the relationship is built on trust.”',
    'testimonials.leila.role': 'Sales Manager — Madariss Achbal Al Atlas',
    ...
    'faq.a1': 'We generate qualified prospects for service businesses: schools, training, B2B/B2C services, real estate. Clear goal: leads that can become appointments and clients — not just visibility.',
    'faq.q2': 'Who is this for?',
    'faq.a2': 'For companies in Morocco and France that sell a service and want a predictable flow of qualified requests. Ideal if you already have a clear offer and a way to handle leads.',
    ...
    'cta.text': 'If you sell a service and want a clear acquisition system in Morocco or France, let’s talk. Limited spots to protect quality.',
    ...
    'contact.sidebar.desc': 'In this call, we share a clear action plan to generate more qualified leads and improve your ROI — in Morocco and France.',
    ...
    'sys.2.text': 'Meta & Google focused on qualified prospects — no wasted budget.',
    'sys.2.t1': '+ Meta & Instagram',
    'sys.2.t2': '+ Google Ads',
    ...
    'promise.heading': 'Specialists in qualified lead generation<span class="promise__dot">.</span>',
    ...
    'about.hero.title': 'Leads. Not just visibility.',
    'about.hero.lead': '63 Agency helps service businesses in Morocco and France generate qualified prospects — fast, clear, measurable.',
    'about.story.1': 'We support companies that want to stop “doing marketing” and start filling their sales pipeline.',
    'about.story.2': 'Our method combines four levers: content, advertising, qualification, and sales follow-up.',
    'about.story.3': 'The goal: attract the right people, convert them into qualified prospects, and turn more opportunities into clients.',
    'about.path.eyebrow': 'The acquisition journey',
    'about.path.title': 'We don’t sell clicks. We build a flow of prospects.',
    'about.path.sub': 'Here’s the journey we install:',
    ...
    'about.metric.title': 'The only metric that matters: growth.',
    'about.metric.1': 'Our work doesn’t stop at a filled form.',
    'about.metric.2': 'We look at what happens next: replies, meetings, show-ups, signed clients.',
    'about.metric.3': 'Because marketing only has value when it grows your revenue.',
    ...
    'sfaq.a6': 'We analyze continuously, optimize what converts, cut what doesn’t — then increase volume based on your goals.'
  }
};
