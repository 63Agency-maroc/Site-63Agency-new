...
const translations = {
  fr: {
    ...
    'about.story.label': 'La vérité',
    'about.story.hook.title': 'Vous payez pour être vus. Puis… silence.',
    'about.story.hook.text': 'Des pubs. Des clics. Des formulaires. Et un pipeline vide. Ce n’est pas un manque d’effort — c’est l’absence d’un système qui transforme l’attention en rendez-vous.',
  ...
  en: {
    ...
    'about.story.label': 'The truth',
    'about.story.hook.title': 'You pay to be seen. Then… silence.',
    'about.story.hook.text': 'Ads. Clicks. Forms. And an empty pipeline. That’s not a lack of effort — it’s the absence of a system that turns attention into meetings.',
