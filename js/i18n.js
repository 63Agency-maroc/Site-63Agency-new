...
const translations = {
  fr: {
    ...
    'statement.title': 'Notre système',
    'statement.text': 'Un process en 5 étapes : du positionnement au scaling, pour transformer l’attention en prospects qualifiés et en rendez-vous — de façon prévisible.',
    ...
    'cta.text': '<span class="cta__text-line">Si vous vendez un service et voulez un système d’acquisition clair, parlons-en.</span><span class="cta__text-line">Places limitées pour garder la qualité.</span>',
    ...
    'footer.copy': '© 2026 63 Agency Tous droits réservés.',
    ...
    'sys.3.text': 'Qui passe, qui ne passe pas : on bloque les leads non qualifiés avant qu’ils n’arrivent à votre équipe commerciale.',
    'sys.3.t1': '+ Qui passe / qui est bloqué',
    'sys.3.t2': '+ Filtre avant le sales',
    ...
    'about.scroll.title': 'La plupart des entreprises<br>n’ont pas un problème<br>de marketing.',
    'about.scroll.hint': 'Elles ont un problème de système. Voici comment le nôtre change tout.',
    'about.story.1.title': 'Sans message clair, chaque budget brûlé est du bruit.',
    'about.story.1.text': 'On commence là où tout se joue : votre positionnement, votre offre, vos messages. Parce qu’une campagne sans clarté ne génère pas de leads — elle génère de la confusion coûteuse.',
    'about.story.2.title': 'Les pubs n’inventent pas la demande. Elles l’amplifient.',
    'about.story.2.text': 'Meta et Google ne sauvent pas une offre floue. Une fois le message tranchant, on scale l’attention vers les bonnes personnes — prospects qualifiés, pas juste des impressions.',
    'about.story.3.title': 'Qui passe. Qui est bloqué. Votre sales ne reçoit que le qualifié.',
    'about.story.3.text': 'Chaque lead est filtré : ceux qui répondent aux critères avancent. Les autres sont bloqués avant d’atteindre votre équipe commerciale. Moins de temps perdu. Plus de rendez-vous qui valent le coup.',
    'about.story.4.title': 'Un lead qui attend 24h est déjà parti chez quelqu’un d’autre.',
    'about.story.4.text': 'Chaque prospect arrive au bon endroit, est suivi et relancé au bon moment. Pas d’Excel oublié. Pas de “on rappelle demain”. Un pipeline vivant — ou rien.',
    'about.story.5.title': 'La croissance n’est pas de la chance. C’est ce que vous mesurez après le clic.',
    'about.story.5.text': 'On regarde ce qui convertit vraiment : réponses, rendez-vous, présence, clients signés. Puis on scale ce qui marche — et on coupe ce qui brûle le budget.',
    'about.story.close.eyebrow': 'La conclusion',
    'about.story.close.title': 'Pas de visibilité.<br><span>Un pipeline.</span>',
    'about.story.close.text': '63 Agency n’existe pas pour vous faire “faire du marketing”. On installe un système en 5 étapes qui transforme l’attention en prospects qualifiés, puis en rendez-vous — de façon prévisible.',
  ...
  en: {
    ...
    'statement.title': 'Our system',
    'statement.text': 'A 5-step process: from positioning to scaling, to turn attention into qualified prospects and meetings — predictably.',
    ...
    'cta.text': '<span class="cta__text-line">If you sell a service and want a clear acquisition system, let’s talk.</span><span class="cta__text-line">Limited spots to protect quality.</span>',
    ...
    'footer.copy': '© 2026 63 Agency All rights reserved.',
    ...
    'sys.3.text': 'Who passes, who doesn’t: we block unqualified leads before they ever reach your sales team.',
    'sys.3.t1': '+ Who passes / who is blocked',
    'sys.3.t2': '+ Filter before sales',
    ...
    'about.scroll.brand': '63 Agency',
    'about.scroll.title': 'Most businesses<br>don’t have a<br>marketing problem.',
    'about.scroll.hint': 'They have a system problem. Here’s how ours changes everything.',
    'about.story.1.title': 'Without a clear message, every budget burned is noise.',
    'about.story.1.text': 'We start where everything is decided: your positioning, offer, and messages. Because a campaign without clarity doesn’t generate leads — it generates expensive confusion.',
    'about.story.2.title': 'Ads don’t invent demand. They amplify it.',
    'about.story.2.text': 'Meta and Google won’t save a blurry offer. Once the message is sharp, we scale attention to the right people — qualified prospects, not just impressions.',
    'about.story.3.title': 'Who passes. Who gets blocked. Your sales team only gets the qualified.',
    'about.story.3.text': 'Every lead is screened: those who meet the criteria move forward. The rest are blocked before they reach your sales team. Less time wasted. More meetings that actually matter.',
    'about.story.4.title': 'A lead that waits 24 hours already left for someone else.',
    'about.story.4.text': 'Every prospect lands in the right place, gets tracked and followed up at the right time. No forgotten spreadsheet. No “we’ll call tomorrow.” A living pipeline — or nothing.',
    'about.story.5.title': 'Growth isn’t luck. It’s what you measure after the click.',
    'about.story.5.text': 'We look at what actually converts: replies, meetings, show-ups, signed clients. Then we scale what works — and cut what burns budget.',
    'about.story.close.eyebrow': 'The close',
    'about.story.close.title': 'Not visibility.<br><span>A pipeline.</span>',
    'about.story.close.text': '63 Agency doesn’t exist to make you “do marketing.” We install a 5-step system that turns attention into qualified prospects, then into meetings — predictably.',
