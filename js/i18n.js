...
const translations = {
  fr: {
    ...
    'contact.alert.text': 'Pour garantir qualité maximale : 3 nouveaux clients/mois seulement.',
  ...
  en: {
    ...
    'contact.alert.text': 'To guarantee maximum quality: only 3 new clients per month.',
